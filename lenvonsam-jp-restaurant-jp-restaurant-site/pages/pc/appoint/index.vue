...
.pc-content.bg-light-green.padding.pt-30.pb-50
  ...
  .pc-appoint-card-content
    ...
    m-input.mt-15(placeholder="$pc18n.t('appointment.text16')", textCenter, :list="appointRangeList", v-model="localForm.appointRange")
    .row.mt-15
      .col.pr-5
    ...
    a-textarea.mt-15.text-center(size="large", :maxLength="250", placeholder="$pc18n.t('appointment.text17')", v-model="localForm.remark", :rows="6")
